...
public inline fun platformMetadata(block: com.example.arduinoide.data.cli.protocol_buffers.PlatformMetadataKt.Dsl.() -> kotlin.Unit): com.example.arduinoide.data.cli.protocol_buffers.Common.PlatformMetadata =
  com.example.arduinoide.data.cli.protocol_buffers.PlatformMetadataKt.Dsl._create(com.example.arduinoide.data.cli.protocol_buffers.Common.PlatformMetadata.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `com.example.arduinoide.data.cli.protocol_buffers.PlatformMetadata`
 */
public object PlatformMetadataKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.example.arduinoide.data.cli.protocol_buffers.Common.PlatformMetadata.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.example.arduinoide.data.cli.protocol_buffers.Common.PlatformMetadata.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.example.arduinoide.data.cli.protocol_buffers.Common.PlatformMetadata = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.example.arduinoide.data.cli.protocol_buffers.Common.PlatformMetadata.copy(block: `com.example.arduinoide.data.cli.protocol_buffers`.PlatformMetadataKt.Dsl.() -> kotlin.Unit): com.example.arduinoide.data.cli.protocol_buffers.Common.PlatformMetadata =
  `com.example.arduinoide.data.cli.protocol_buffers`.PlatformMetadataKt.Dsl._create(this.toBuilder()).apply { block() }._build()
