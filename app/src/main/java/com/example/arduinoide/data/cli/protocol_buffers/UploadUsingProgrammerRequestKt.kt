...
@kotlin.jvm.JvmName("-initializeuploadUsingProgrammerRequest")
public inline fun uploadUsingProgrammerRequest(block: com.example.arduinoide.data.cli.protocol_buffers.UploadUsingProgrammerRequestKt.Dsl.() -> kotlin.Unit): com.example.arduinoide.data.cli.protocol_buffers.Upload.UploadUsingProgrammerRequest =
  com.example.arduinoide.data.cli.protocol_buffers.UploadUsingProgrammerRequestKt.Dsl._create(com.example.arduinoide.data.cli.protocol_buffers.Upload.UploadUsingProgrammerRequest.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `com.example.arduinoide.data.cli.protocol_buffers.UploadUsingProgrammerRequest`
 */
public object UploadUsingProgrammerRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.example.arduinoide.data.cli.protocol_buffers.Upload.UploadUsingProgrammerRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.example.arduinoide.data.cli.protocol_buffers.Upload.UploadUsingProgrammerRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.example.arduinoide.data.cli.protocol_buffers.Upload.UploadUsingProgrammerRequest = _builder.build()
    ...
    public val UploadUsingProgrammerRequestKt.Dsl.instanceOrNull: com.example.arduinoide.data.cli.protocol_buffers.Common.Instance?
    ...
    public val UploadUsingProgrammerRequestKt.Dsl.portOrNull: com.example.arduinoide.data.cli.protocol_buffers.PortOuterClass.Port?
...
@kotlin.jvm.JvmSynthetic
public inline fun com.example.arduinoide.data.cli.protocol_buffers.Upload.UploadUsingProgrammerRequest.copy(block: `com.example.arduinoide.data.cli.protocol_buffers`.UploadUsingProgrammerRequestKt.Dsl.() -> kotlin.Unit): com.example.arduinoide.data.cli.protocol_buffers.Upload.UploadUsingProgrammerRequest =
  `com.example.arduinoide.data.cli.protocol_buffers`.UploadUsingProgrammerRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val com.example.arduinoide.data.cli.protocol_buffers.Upload.UploadUsingProgrammerRequestOrBuilder.instanceOrNull: com.example.arduinoide.data.cli.protocol_buffers.Common.Instance?
  get() = if (hasInstance()) getInstance() else null

public val com.example.arduinoide.data.cli.protocol_buffers.Upload.UploadUsingProgrammerRequestOrBuilder.portOrNull: com.example.arduinoide.data.cli.protocol_buffers.PortOuterClass.Port?
