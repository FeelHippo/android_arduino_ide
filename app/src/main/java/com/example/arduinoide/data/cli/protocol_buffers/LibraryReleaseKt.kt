...
public inline fun libraryRelease(block: com.example.arduinoide.data.cli.protocol_buffers.LibraryReleaseKt.Dsl.() -> kotlin.Unit): com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease =
  com.example.arduinoide.data.cli.protocol_buffers.LibraryReleaseKt.Dsl._create(com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `com.example.arduinoide.data.cli.protocol_buffers.LibraryRelease`
 */
public object LibraryReleaseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease = _builder.build()
...
@kotlin.jvm.JvmName("setTypes")
     ...
     * ```
     *
     * `.com.example.arduinoide.data.cli.protocol_buffers.DownloadResource resources = 10;`
     */
    public var resources: com.example.arduinoide.data.cli.protocol_buffers.Lib.DownloadResource
    ...
    public val LibraryReleaseKt.Dsl.resourcesOrNull: com.example.arduinoide.data.cli.protocol_buffers.Lib.DownloadResource?
...
@kotlin.jvm.JvmName("setProvidesIncludes")
     ...
     * ```
     *
     * `repeated .com.example.arduinoide.data.cli.protocol_buffers.LibraryDependency dependencies = 13;`
     */
     public val dependencies: com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryDependency, DependenciesProxy>
      @kotlin.jvm.JvmSynthetic
  get() = com.google.protobuf.kotlin.DslList(
...
@kotlin.jvm.JvmName("addDependencies")
    public fun com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryDependency, DependenciesProxy>.add(value: com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryDependency) {
...
@kotlin.jvm.JvmName("plusAssignDependencies")
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryDependency, DependenciesProxy>.plusAssign(value: com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryDependency) {
      add(value)
    }
    /**
     * ```
...
@kotlin.jvm.JvmName("addAllDependencies")
    public fun com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryDependency, DependenciesProxy>.addAll(values: kotlin.collections.Iterable<com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryDependency>) {
...
@kotlin.jvm.JvmName("plusAssignAllDependencies")
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryDependency, DependenciesProxy>.plusAssign(values: kotlin.collections.Iterable<com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryDependency>) {
      addAll(values)
    }
    /**
     * ```
...
@kotlin.jvm.JvmName("setDependencies")
    public operator fun com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryDependency, DependenciesProxy>.set(index: kotlin.Int, value: com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryDependency) {
...
@kotlin.jvm.JvmName("clearDependencies")
    public fun com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryDependency, DependenciesProxy>.clear() {
      _builder.clearDependencies()
    }
  }
}
@kotlin.jvm.JvmSynthetic
public inline fun com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease.copy(block: `com.example.arduinoide.data.cli.protocol_buffers`.LibraryReleaseKt.Dsl.() -> kotlin.Unit): com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease =
  `com.example.arduinoide.data.cli.protocol_buffers`.LibraryReleaseKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryReleaseOrBuilder.resourcesOrNull: com.example.arduinoide.data.cli.protocol_buffers.Lib.DownloadResource?
