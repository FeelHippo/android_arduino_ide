...
public inline fun library(block: com.example.arduinoide.data.cli.protocol_buffers.LibraryKt.Dsl.() -> kotlin.Unit): com.example.arduinoide.data.cli.protocol_buffers.Lib.Library =
  com.example.arduinoide.data.cli.protocol_buffers.LibraryKt.Dsl._create(com.example.arduinoide.data.cli.protocol_buffers.Lib.Library.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `com.example.arduinoide.data.cli.protocol_buffers.Library`
 */
public object LibraryKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.example.arduinoide.data.cli.protocol_buffers.Lib.Library.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.example.arduinoide.data.cli.protocol_buffers.Lib.Library.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.example.arduinoide.data.cli.protocol_buffers.Lib.Library = _builder.build()
...
@kotlin.jvm.JvmName("clearProperties")
     ...
     * ```
     *
     * `.com.example.arduinoide.data.cli.protocol_buffers.LibraryLocation location = 24;`
     */
    public var location: com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryLocation
     ...
     * ```
     *
     * `.com.example.arduinoide.data.cli.protocol_buffers.LibraryLayout layout = 25;`
     */
    public var layout: com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryLayout
...
@kotlin.jvm.JvmSynthetic
public inline fun com.example.arduinoide.data.cli.protocol_buffers.Lib.Library.copy(block: `com.example.arduinoide.data.cli.protocol_buffers`.LibraryKt.Dsl.() -> kotlin.Unit): com.example.arduinoide.data.cli.protocol_buffers.Lib.Library =
  `com.example.arduinoide.data.cli.protocol_buffers`.LibraryKt.Dsl._create(this.toBuilder()).apply { block() }._build()
