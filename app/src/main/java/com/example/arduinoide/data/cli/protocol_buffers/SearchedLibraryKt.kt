...
public inline fun searchedLibrary(block: com.example.arduinoide.data.cli.protocol_buffers.SearchedLibraryKt.Dsl.() -> kotlin.Unit): com.example.arduinoide.data.cli.protocol_buffers.Lib.SearchedLibrary =
  com.example.arduinoide.data.cli.protocol_buffers.SearchedLibraryKt.Dsl._create(com.example.arduinoide.data.cli.protocol_buffers.Lib.SearchedLibrary.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `com.example.arduinoide.data.cli.protocol_buffers.SearchedLibrary`
 */
public object SearchedLibraryKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.example.arduinoide.data.cli.protocol_buffers.Lib.SearchedLibrary.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.example.arduinoide.data.cli.protocol_buffers.Lib.SearchedLibrary.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.example.arduinoide.data.cli.protocol_buffers.Lib.SearchedLibrary = _builder.build()
     ...
     * ```
     *
     * `map<string, .com.example.arduinoide.data.cli.protocol_buffers.LibraryRelease> releases = 2;`
     */
     public val releases: com.google.protobuf.kotlin.DslMap<kotlin.String, com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease, ReleasesProxy>
      @kotlin.jvm.JvmSynthetic
@kotlin.jvm.JvmName("getReleasesMap")
    ...
    public fun com.google.protobuf.kotlin.DslMap<kotlin.String, com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease, ReleasesProxy>
      .put(key: kotlin.String, value: com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease) {
...
@kotlin.jvm.JvmName("setReleases")
    ...
    public inline operator fun com.google.protobuf.kotlin.DslMap<kotlin.String, com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease, ReleasesProxy>
      .set(key: kotlin.String, value: com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease) {
         put(key, value)
       }
    /**
     * ```
...
@kotlin.jvm.JvmName("putAllReleases")
    public fun com.google.protobuf.kotlin.DslMap<kotlin.String, com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease, ReleasesProxy>
      .putAll(map: kotlin.collections.Map<kotlin.String, com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease>) {
...
@kotlin.jvm.JvmName("clearReleases")
     ...
     * ```
     *
     * `.com.example.arduinoide.data.cli.protocol_buffers.LibraryRelease latest = 3;`
     */
    public var latest: com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease
    ...
    public val SearchedLibraryKt.Dsl.latestOrNull: com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease?
...
@kotlin.jvm.JvmSynthetic
public inline fun com.example.arduinoide.data.cli.protocol_buffers.Lib.SearchedLibrary.copy(block: `com.example.arduinoide.data.cli.protocol_buffers`.SearchedLibraryKt.Dsl.() -> kotlin.Unit): com.example.arduinoide.data.cli.protocol_buffers.Lib.SearchedLibrary =
  `com.example.arduinoide.data.cli.protocol_buffers`.SearchedLibraryKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val com.example.arduinoide.data.cli.protocol_buffers.Lib.SearchedLibraryOrBuilder.latestOrNull: com.example.arduinoide.data.cli.protocol_buffers.Lib.LibraryRelease?
