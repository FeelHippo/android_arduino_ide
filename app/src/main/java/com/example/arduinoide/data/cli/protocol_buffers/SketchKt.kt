...
public inline fun sketch(block: com.example.arduinoide.data.cli.protocol_buffers.SketchKt.Dsl.() -> kotlin.Unit): com.example.arduinoide.data.cli.protocol_buffers.Common.Sketch =
  com.example.arduinoide.data.cli.protocol_buffers.SketchKt.Dsl._create(com.example.arduinoide.data.cli.protocol_buffers.Common.Sketch.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `com.example.arduinoide.data.cli.protocol_buffers.Sketch`
 */
public object SketchKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.example.arduinoide.data.cli.protocol_buffers.Common.Sketch.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: com.example.arduinoide.data.cli.protocol_buffers.Common.Sketch.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): com.example.arduinoide.data.cli.protocol_buffers.Common.Sketch = _builder.build()
...
@kotlin.jvm.JvmName("setRootFolderFiles")
     ...
     * ```
     *
     * `repeated .com.example.arduinoide.data.cli.protocol_buffers.SketchProfile profiles = 9;`
     */
     public val profiles: com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile, ProfilesProxy>
      @kotlin.jvm.JvmSynthetic
  get() = com.google.protobuf.kotlin.DslList(
...
@kotlin.jvm.JvmName("addProfiles")
    public fun com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile, ProfilesProxy>.add(value: com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile) {
...
@kotlin.jvm.JvmName("plusAssignProfiles")
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile, ProfilesProxy>.plusAssign(value: com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile) {
      add(value)
    }
    /**
     * ```
...
@kotlin.jvm.JvmName("addAllProfiles")
    public fun com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile, ProfilesProxy>.addAll(values: kotlin.collections.Iterable<com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile>) {
...
@kotlin.jvm.JvmName("plusAssignAllProfiles")
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile, ProfilesProxy>.plusAssign(values: kotlin.collections.Iterable<com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile>) {
      addAll(values)
    }
    /**
     * ```
...
@kotlin.jvm.JvmName("setProfiles")
    public operator fun com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile, ProfilesProxy>.set(index: kotlin.Int, value: com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile) {
...
@kotlin.jvm.JvmName("clearProfiles")
    public fun com.google.protobuf.kotlin.DslList<com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile, ProfilesProxy>.clear() {
     ...
     * ```
     *
     * `.com.example.arduinoide.data.cli.protocol_buffers.SketchProfile default_profile = 10;`
     */
    public var defaultProfile: com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile
    ...
    public val SketchKt.Dsl.defaultProfileOrNull: com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile?
     ...
     * ```
     *
     * `.com.example.arduinoide.data.cli.protocol_buffers.MonitorPortConfiguration default_port_config = 12;`
     */
    public var defaultPortConfig: com.example.arduinoide.data.cli.protocol_buffers.Common.MonitorPortConfiguration
    ...
    public val SketchKt.Dsl.defaultPortConfigOrNull: com.example.arduinoide.data.cli.protocol_buffers.Common.MonitorPortConfiguration?
      get() = _builder.defaultPortConfigOrNull
  }
}
@kotlin.jvm.JvmSynthetic
public inline fun com.example.arduinoide.data.cli.protocol_buffers.Common.Sketch.copy(block: `com.example.arduinoide.data.cli.protocol_buffers`.SketchKt.Dsl.() -> kotlin.Unit): com.example.arduinoide.data.cli.protocol_buffers.Common.Sketch =
  `com.example.arduinoide.data.cli.protocol_buffers`.SketchKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val com.example.arduinoide.data.cli.protocol_buffers.Common.SketchOrBuilder.defaultProfileOrNull: com.example.arduinoide.data.cli.protocol_buffers.Common.SketchProfile?
  get() = if (hasDefaultProfile()) getDefaultProfile() else null

public val com.example.arduinoide.data.cli.protocol_buffers.Common.SketchOrBuilder.defaultPortConfigOrNull: com.example.arduinoide.data.cli.protocol_buffers.Common.MonitorPortConfiguration?
