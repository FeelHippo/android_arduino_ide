...
public inline fun searchedLibrary(block: compiled_protocol_buffers.SearchedLibraryKt.Dsl.() -> kotlin.Unit): compiled_protocol_buffers.Lib.SearchedLibrary =
  compiled_protocol_buffers.SearchedLibraryKt.Dsl._create(compiled_protocol_buffers.Lib.SearchedLibrary.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `compiled_protocol_buffers.SearchedLibrary`
 */
public object SearchedLibraryKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: compiled_protocol_buffers.Lib.SearchedLibrary.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: compiled_protocol_buffers.Lib.SearchedLibrary.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): compiled_protocol_buffers.Lib.SearchedLibrary = _builder.build()
     ...
     * ```
     *
     * `map<string, .compiled_protocol_buffers.LibraryRelease> releases = 2;`
     */
     public val releases: com.google.protobuf.kotlin.DslMap<kotlin.String, compiled_protocol_buffers.Lib.LibraryRelease, ReleasesProxy>
      @kotlin.jvm.JvmSynthetic
@kotlin.jvm.JvmName("getReleasesMap")
    ...
    public fun com.google.protobuf.kotlin.DslMap<kotlin.String, compiled_protocol_buffers.Lib.LibraryRelease, ReleasesProxy>
      .put(key: kotlin.String, value: compiled_protocol_buffers.Lib.LibraryRelease) {
...
@kotlin.jvm.JvmName("setReleases")
    ...
    public inline operator fun com.google.protobuf.kotlin.DslMap<kotlin.String, compiled_protocol_buffers.Lib.LibraryRelease, ReleasesProxy>
      .set(key: kotlin.String, value: compiled_protocol_buffers.Lib.LibraryRelease) {
         put(key, value)
       }
    /**
     * ```
...
@kotlin.jvm.JvmName("putAllReleases")
    public fun com.google.protobuf.kotlin.DslMap<kotlin.String, compiled_protocol_buffers.Lib.LibraryRelease, ReleasesProxy>
      .putAll(map: kotlin.collections.Map<kotlin.String, compiled_protocol_buffers.Lib.LibraryRelease>) {
...
@kotlin.jvm.JvmName("clearReleases")
     ...
     * ```
     *
     * `.compiled_protocol_buffers.LibraryRelease latest = 3;`
     */
    public var latest: compiled_protocol_buffers.Lib.LibraryRelease
    ...
    public val SearchedLibraryKt.Dsl.latestOrNull: compiled_protocol_buffers.Lib.LibraryRelease?
...
@kotlin.jvm.JvmSynthetic
public inline fun compiled_protocol_buffers.Lib.SearchedLibrary.copy(block: `compiled_protocol_buffers`.SearchedLibraryKt.Dsl.() -> kotlin.Unit): compiled_protocol_buffers.Lib.SearchedLibrary =
  `compiled_protocol_buffers`.SearchedLibraryKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val compiled_protocol_buffers.Lib.SearchedLibraryOrBuilder.latestOrNull: compiled_protocol_buffers.Lib.LibraryRelease?
