...
public inline fun platformRelease(block: compiled_protocol_buffers.PlatformReleaseKt.Dsl.() -> kotlin.Unit): compiled_protocol_buffers.Common.PlatformRelease =
  compiled_protocol_buffers.PlatformReleaseKt.Dsl._create(compiled_protocol_buffers.Common.PlatformRelease.newBuilder()).apply { block() }._build()
/**
 * ```
 * PlatformRelease contains information about a specific release of a platform.
 * ```
 *
 * Protobuf type `compiled_protocol_buffers.PlatformRelease`
 */
public object PlatformReleaseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: compiled_protocol_buffers.Common.PlatformRelease.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: compiled_protocol_buffers.Common.PlatformRelease.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): compiled_protocol_buffers.Common.PlatformRelease = _builder.build()
...
@kotlin.jvm.JvmName("setTypes")
     ...
     * ```
     *
     * `repeated .compiled_protocol_buffers.Board boards = 5;`
     */
     public val boards: com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Common.Board, BoardsProxy>
      @kotlin.jvm.JvmSynthetic
  get() = com.google.protobuf.kotlin.DslList(
        _builder.boardsList
      )
...
@kotlin.jvm.JvmName("addBoards")
    public fun com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Common.Board, BoardsProxy>.add(value: compiled_protocol_buffers.Common.Board) {
...
@kotlin.jvm.JvmName("plusAssignBoards")
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Common.Board, BoardsProxy>.plusAssign(value: compiled_protocol_buffers.Common.Board) {
      add(value)
    }
    /**
     * ```
...
@kotlin.jvm.JvmName("addAllBoards")
    public fun com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Common.Board, BoardsProxy>.addAll(values: kotlin.collections.Iterable<compiled_protocol_buffers.Common.Board>) {
...
@kotlin.jvm.JvmName("plusAssignAllBoards")
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Common.Board, BoardsProxy>.plusAssign(values: kotlin.collections.Iterable<compiled_protocol_buffers.Common.Board>) {
      addAll(values)
    }
    /**
     * ```
...
@kotlin.jvm.JvmName("setBoards")
    public operator fun com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Common.Board, BoardsProxy>.set(index: kotlin.Int, value: compiled_protocol_buffers.Common.Board) {
...
@kotlin.jvm.JvmName("clearBoards")
    public fun com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Common.Board, BoardsProxy>.clear() {
     ...
     * ```
     *
     * `.compiled_protocol_buffers.HelpResources help = 6;`
     */
    public var help: compiled_protocol_buffers.Common.HelpResources
    ...
    public val PlatformReleaseKt.Dsl.helpOrNull: compiled_protocol_buffers.Common.HelpResources?
...
@kotlin.jvm.JvmSynthetic
public inline fun compiled_protocol_buffers.Common.PlatformRelease.copy(block: `compiled_protocol_buffers`.PlatformReleaseKt.Dsl.() -> kotlin.Unit): compiled_protocol_buffers.Common.PlatformRelease =
  `compiled_protocol_buffers`.PlatformReleaseKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val compiled_protocol_buffers.Common.PlatformReleaseOrBuilder.helpOrNull: compiled_protocol_buffers.Common.HelpResources?
