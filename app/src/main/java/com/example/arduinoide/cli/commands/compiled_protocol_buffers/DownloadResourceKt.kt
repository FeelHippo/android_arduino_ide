...
public inline fun downloadResource(block: compiled_protocol_buffers.DownloadResourceKt.Dsl.() -> kotlin.Unit): compiled_protocol_buffers.Lib.DownloadResource =
  compiled_protocol_buffers.DownloadResourceKt.Dsl._create(compiled_protocol_buffers.Lib.DownloadResource.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `compiled_protocol_buffers.DownloadResource`
 */
public object DownloadResourceKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: compiled_protocol_buffers.Lib.DownloadResource.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: compiled_protocol_buffers.Lib.DownloadResource.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): compiled_protocol_buffers.Lib.DownloadResource = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun compiled_protocol_buffers.Lib.DownloadResource.copy(block: `compiled_protocol_buffers`.DownloadResourceKt.Dsl.() -> kotlin.Unit): compiled_protocol_buffers.Lib.DownloadResource =
  `compiled_protocol_buffers`.DownloadResourceKt.Dsl._create(this.toBuilder()).apply { block() }._build()
