...
public inline fun libraryRelease(block: compiled_protocol_buffers.LibraryReleaseKt.Dsl.() -> kotlin.Unit): compiled_protocol_buffers.Lib.LibraryRelease =
  compiled_protocol_buffers.LibraryReleaseKt.Dsl._create(compiled_protocol_buffers.Lib.LibraryRelease.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `compiled_protocol_buffers.LibraryRelease`
 */
public object LibraryReleaseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: compiled_protocol_buffers.Lib.LibraryRelease.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: compiled_protocol_buffers.Lib.LibraryRelease.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): compiled_protocol_buffers.Lib.LibraryRelease = _builder.build()
...
@kotlin.jvm.JvmName("setTypes")
     ...
     * ```
     *
     * `.compiled_protocol_buffers.DownloadResource resources = 10;`
     */
    public var resources: compiled_protocol_buffers.Lib.DownloadResource
    ...
    public val LibraryReleaseKt.Dsl.resourcesOrNull: compiled_protocol_buffers.Lib.DownloadResource?
...
@kotlin.jvm.JvmName("setProvidesIncludes")
     ...
     * ```
     *
     * `repeated .compiled_protocol_buffers.LibraryDependency dependencies = 13;`
     */
     public val dependencies: com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Lib.LibraryDependency, DependenciesProxy>
      @kotlin.jvm.JvmSynthetic
  get() = com.google.protobuf.kotlin.DslList(
...
@kotlin.jvm.JvmName("addDependencies")
    public fun com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Lib.LibraryDependency, DependenciesProxy>.add(value: compiled_protocol_buffers.Lib.LibraryDependency) {
...
@kotlin.jvm.JvmName("plusAssignDependencies")
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Lib.LibraryDependency, DependenciesProxy>.plusAssign(value: compiled_protocol_buffers.Lib.LibraryDependency) {
      add(value)
    }
    /**
     * ```
...
@kotlin.jvm.JvmName("addAllDependencies")
    public fun com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Lib.LibraryDependency, DependenciesProxy>.addAll(values: kotlin.collections.Iterable<compiled_protocol_buffers.Lib.LibraryDependency>) {
...
@kotlin.jvm.JvmName("plusAssignAllDependencies")
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Lib.LibraryDependency, DependenciesProxy>.plusAssign(values: kotlin.collections.Iterable<compiled_protocol_buffers.Lib.LibraryDependency>) {
      addAll(values)
    }
    /**
     * ```
...
@kotlin.jvm.JvmName("setDependencies")
    public operator fun com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Lib.LibraryDependency, DependenciesProxy>.set(index: kotlin.Int, value: compiled_protocol_buffers.Lib.LibraryDependency) {
...
@kotlin.jvm.JvmName("clearDependencies")
    public fun com.google.protobuf.kotlin.DslList<compiled_protocol_buffers.Lib.LibraryDependency, DependenciesProxy>.clear() {
      _builder.clearDependencies()
    }
  }
}
@kotlin.jvm.JvmSynthetic
public inline fun compiled_protocol_buffers.Lib.LibraryRelease.copy(block: `compiled_protocol_buffers`.LibraryReleaseKt.Dsl.() -> kotlin.Unit): compiled_protocol_buffers.Lib.LibraryRelease =
  `compiled_protocol_buffers`.LibraryReleaseKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val compiled_protocol_buffers.Lib.LibraryReleaseOrBuilder.resourcesOrNull: compiled_protocol_buffers.Lib.DownloadResource?
