...
public inline fun compileRequest(block: main.proto.CompileRequestKt.Dsl.() -> kotlin.Unit): main.proto.Compile.CompileRequest =
  main.proto.CompileRequestKt.Dsl._create(main.proto.Compile.CompileRequest.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `main.proto.CompileRequest`
 */
public object CompileRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: main.proto.Compile.CompileRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: main.proto.Compile.CompileRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): main.proto.Compile.CompileRequest = _builder.build()
    ...
    public val CompileRequestKt.Dsl.instanceOrNull: main.proto.Common.Instance?
...
@kotlin.jvm.JvmSynthetic
public inline fun main.proto.Compile.CompileRequest.copy(block: `main.proto`.CompileRequestKt.Dsl.() -> kotlin.Unit): main.proto.Compile.CompileRequest =
  `main.proto`.CompileRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val main.proto.Compile.CompileRequestOrBuilder.instanceOrNull: main.proto.Common.Instance?
