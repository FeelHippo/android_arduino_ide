...
public inline fun library(block: main.proto.LibraryKt.Dsl.() -> kotlin.Unit): main.proto.Lib.Library =
  main.proto.LibraryKt.Dsl._create(main.proto.Lib.Library.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `main.proto.Library`
 */
public object LibraryKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: main.proto.Lib.Library.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: main.proto.Lib.Library.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): main.proto.Lib.Library = _builder.build()
...
@kotlin.jvm.JvmName("clearProperties")
     ...
     * ```
     *
     * `.main.proto.LibraryLocation location = 24;`
     */
    public var location: main.proto.Lib.LibraryLocation
     ...
     * ```
     *
     * `.main.proto.LibraryLayout layout = 25;`
     */
    public var layout: main.proto.Lib.LibraryLayout
...
@kotlin.jvm.JvmSynthetic
public inline fun main.proto.Lib.Library.copy(block: `main.proto`.LibraryKt.Dsl.() -> kotlin.Unit): main.proto.Lib.Library =
  `main.proto`.LibraryKt.Dsl._create(this.toBuilder()).apply { block() }._build()
