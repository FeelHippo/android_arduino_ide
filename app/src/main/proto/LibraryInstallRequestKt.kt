...
public inline fun libraryInstallRequest(block: main.proto.LibraryInstallRequestKt.Dsl.() -> kotlin.Unit): main.proto.Lib.LibraryInstallRequest =
  main.proto.LibraryInstallRequestKt.Dsl._create(main.proto.Lib.LibraryInstallRequest.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `main.proto.LibraryInstallRequest`
 */
public object LibraryInstallRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: main.proto.Lib.LibraryInstallRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: main.proto.Lib.LibraryInstallRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): main.proto.Lib.LibraryInstallRequest = _builder.build()
    ...
    public val LibraryInstallRequestKt.Dsl.instanceOrNull: main.proto.Common.Instance?
     ...
     * ```
     *
     * `.main.proto.LibraryInstallLocation install_location = 6;`
     */
    public var installLocation: main.proto.Lib.LibraryInstallLocation
...
@kotlin.jvm.JvmSynthetic
public inline fun main.proto.Lib.LibraryInstallRequest.copy(block: `main.proto`.LibraryInstallRequestKt.Dsl.() -> kotlin.Unit): main.proto.Lib.LibraryInstallRequest =
  `main.proto`.LibraryInstallRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val main.proto.Lib.LibraryInstallRequestOrBuilder.instanceOrNull: main.proto.Common.Instance?
