...
public inline fun downloadResource(block: main.proto.DownloadResourceKt.Dsl.() -> kotlin.Unit): main.proto.Lib.DownloadResource =
  main.proto.DownloadResourceKt.Dsl._create(main.proto.Lib.DownloadResource.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `main.proto.DownloadResource`
 */
public object DownloadResourceKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: main.proto.Lib.DownloadResource.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: main.proto.Lib.DownloadResource.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): main.proto.Lib.DownloadResource = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun main.proto.Lib.DownloadResource.copy(block: `main.proto`.DownloadResourceKt.Dsl.() -> kotlin.Unit): main.proto.Lib.DownloadResource =
  `main.proto`.DownloadResourceKt.Dsl._create(this.toBuilder()).apply { block() }._build()
