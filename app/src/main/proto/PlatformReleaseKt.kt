...
public inline fun platformRelease(block: main.proto.PlatformReleaseKt.Dsl.() -> kotlin.Unit): main.proto.Common.PlatformRelease =
  main.proto.PlatformReleaseKt.Dsl._create(main.proto.Common.PlatformRelease.newBuilder()).apply { block() }._build()
/**
 * ```
 * PlatformRelease contains information about a specific release of a platform.
 * ```
 *
 * Protobuf type `main.proto.PlatformRelease`
 */
public object PlatformReleaseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: main.proto.Common.PlatformRelease.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: main.proto.Common.PlatformRelease.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): main.proto.Common.PlatformRelease = _builder.build()
...
@kotlin.jvm.JvmName("setTypes")
     ...
     * ```
     *
     * `repeated .main.proto.Board boards = 5;`
     */
     public val boards: com.google.protobuf.kotlin.DslList<main.proto.Common.Board, BoardsProxy>
      @kotlin.jvm.JvmSynthetic
  get() = com.google.protobuf.kotlin.DslList(
        _builder.boardsList
      )
...
@kotlin.jvm.JvmName("addBoards")
    public fun com.google.protobuf.kotlin.DslList<main.proto.Common.Board, BoardsProxy>.add(value: main.proto.Common.Board) {
...
@kotlin.jvm.JvmName("plusAssignBoards")
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<main.proto.Common.Board, BoardsProxy>.plusAssign(value: main.proto.Common.Board) {
      add(value)
    }
    /**
     * ```
...
@kotlin.jvm.JvmName("addAllBoards")
    public fun com.google.protobuf.kotlin.DslList<main.proto.Common.Board, BoardsProxy>.addAll(values: kotlin.collections.Iterable<main.proto.Common.Board>) {
...
@kotlin.jvm.JvmName("plusAssignAllBoards")
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<main.proto.Common.Board, BoardsProxy>.plusAssign(values: kotlin.collections.Iterable<main.proto.Common.Board>) {
      addAll(values)
    }
    /**
     * ```
...
@kotlin.jvm.JvmName("setBoards")
    public operator fun com.google.protobuf.kotlin.DslList<main.proto.Common.Board, BoardsProxy>.set(index: kotlin.Int, value: main.proto.Common.Board) {
...
@kotlin.jvm.JvmName("clearBoards")
    public fun com.google.protobuf.kotlin.DslList<main.proto.Common.Board, BoardsProxy>.clear() {
     ...
     * ```
     *
     * `.main.proto.HelpResources help = 6;`
     */
    public var help: main.proto.Common.HelpResources
    ...
    public val PlatformReleaseKt.Dsl.helpOrNull: main.proto.Common.HelpResources?
...
@kotlin.jvm.JvmSynthetic
public inline fun main.proto.Common.PlatformRelease.copy(block: `main.proto`.PlatformReleaseKt.Dsl.() -> kotlin.Unit): main.proto.Common.PlatformRelease =
  `main.proto`.PlatformReleaseKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val main.proto.Common.PlatformReleaseOrBuilder.helpOrNull: main.proto.Common.HelpResources?
