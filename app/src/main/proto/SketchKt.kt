...
public inline fun sketch(block: main.proto.SketchKt.Dsl.() -> kotlin.Unit): main.proto.Common.Sketch =
  main.proto.SketchKt.Dsl._create(main.proto.Common.Sketch.newBuilder()).apply { block() }._build()
/**
 * Protobuf type `main.proto.Sketch`
 */
public object SketchKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: main.proto.Common.Sketch.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
      internal fun _create(builder: main.proto.Common.Sketch.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
  @kotlin.PublishedApi
    internal fun _build(): main.proto.Common.Sketch = _builder.build()
...
@kotlin.jvm.JvmName("setRootFolderFiles")
     ...
     * ```
     *
     * `repeated .main.proto.SketchProfile profiles = 9;`
     */
     public val profiles: com.google.protobuf.kotlin.DslList<main.proto.Common.SketchProfile, ProfilesProxy>
      @kotlin.jvm.JvmSynthetic
  get() = com.google.protobuf.kotlin.DslList(
...
@kotlin.jvm.JvmName("addProfiles")
    public fun com.google.protobuf.kotlin.DslList<main.proto.Common.SketchProfile, ProfilesProxy>.add(value: main.proto.Common.SketchProfile) {
...
@kotlin.jvm.JvmName("plusAssignProfiles")
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<main.proto.Common.SketchProfile, ProfilesProxy>.plusAssign(value: main.proto.Common.SketchProfile) {
      add(value)
    }
    /**
     * ```
...
@kotlin.jvm.JvmName("addAllProfiles")
    public fun com.google.protobuf.kotlin.DslList<main.proto.Common.SketchProfile, ProfilesProxy>.addAll(values: kotlin.collections.Iterable<main.proto.Common.SketchProfile>) {
...
@kotlin.jvm.JvmName("plusAssignAllProfiles")
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<main.proto.Common.SketchProfile, ProfilesProxy>.plusAssign(values: kotlin.collections.Iterable<main.proto.Common.SketchProfile>) {
      addAll(values)
    }
    /**
     * ```
...
@kotlin.jvm.JvmName("setProfiles")
    public operator fun com.google.protobuf.kotlin.DslList<main.proto.Common.SketchProfile, ProfilesProxy>.set(index: kotlin.Int, value: main.proto.Common.SketchProfile) {
...
@kotlin.jvm.JvmName("clearProfiles")
    public fun com.google.protobuf.kotlin.DslList<main.proto.Common.SketchProfile, ProfilesProxy>.clear() {
     ...
     * ```
     *
     * `.main.proto.SketchProfile default_profile = 10;`
     */
    public var defaultProfile: main.proto.Common.SketchProfile
    ...
    public val SketchKt.Dsl.defaultProfileOrNull: main.proto.Common.SketchProfile?
     ...
     * ```
     *
     * `.main.proto.MonitorPortConfiguration default_port_config = 12;`
     */
    public var defaultPortConfig: main.proto.Common.MonitorPortConfiguration
    ...
    public val SketchKt.Dsl.defaultPortConfigOrNull: main.proto.Common.MonitorPortConfiguration?
      get() = _builder.defaultPortConfigOrNull
  }
}
@kotlin.jvm.JvmSynthetic
public inline fun main.proto.Common.Sketch.copy(block: `main.proto`.SketchKt.Dsl.() -> kotlin.Unit): main.proto.Common.Sketch =
  `main.proto`.SketchKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val main.proto.Common.SketchOrBuilder.defaultProfileOrNull: main.proto.Common.SketchProfile?
  get() = if (hasDefaultProfile()) getDefaultProfile() else null

public val main.proto.Common.SketchOrBuilder.defaultPortConfigOrNull: main.proto.Common.MonitorPortConfiguration?
